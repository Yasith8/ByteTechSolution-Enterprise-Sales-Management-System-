 ...
 */
@Entity
@Table(name = "accessories") // map the modularity table
...
public class AccessoriesEntity {
    ...
    @ManyToOne  
     ...
     private ItemStatusEntity itemstatus_id;
      ...
      public AccessoriesEntity(int id,String itemcode,String itmname,CategoryEntity category_id,BrandEntity brand_id){
        this.id=id;
