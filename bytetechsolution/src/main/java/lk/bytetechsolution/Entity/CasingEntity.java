 ...
 */
@Entity
@Table(name = "casing") // map the modularity table
...
public class CasingEntity {
     ...
     */
     ...
     @ManyToOne  
     @JoinColumn(name="casematerial_id",referencedColumnName = "id")
     private CaseMaterialEntity casematerial_id;

     @ManyToOne  
     @JoinColumn(name="casecolor_id",referencedColumnName = "id")
     private CaseColorEntity casecolor_id;
