 ...
 */
@Entity
@Table(name = "powersupply") // map the modularity table
...
public class PowerSupplyEntity {
     ...
     */
     ...
     @ManyToOne  
     @JoinColumn(name="efficiency_id",referencedColumnName = "id")
     private EfficiencyEntity efficiency_id;

     @ManyToOne  
     @JoinColumn(name="modularity_id",referencedColumnName = "id")
     private ModularityEntity modularity_id;
