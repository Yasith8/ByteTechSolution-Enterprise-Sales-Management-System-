...
import lk.bytetechsolution.Dao.CaseMaterialDao;
...
public class CaseMaterialController {
     ...
     */
    @GetMapping(value = "/casematerial/alldata", produces ="application/json" ) 
    public List<CaseMaterialEntity> allEmployeeData() {
