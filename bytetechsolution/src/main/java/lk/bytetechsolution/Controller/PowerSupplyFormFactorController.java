...
import lk.bytetechsolution.Dao.PowerSupplyFormFactorDao;
...
*/
@RestController
public class PowerSupplyFormFactorController {
      /* 
     ...
     */
    @Autowired
    private PowerSupplyFormFactorDao dao;
     /* 
     ...
     */
    @GetMapping(value = "/powersupplyformfactor/alldata", produces ="application/json" ) 
    public List<PowerSupplyFormFactorEntity> allEmployeeData() {
