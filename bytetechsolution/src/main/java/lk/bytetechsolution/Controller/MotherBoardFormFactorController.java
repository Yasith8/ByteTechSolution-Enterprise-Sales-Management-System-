...
import lk.bytetechsolution.Dao.MotherBoardFormFactorDao;
...
public class MotherBoardFormFactorController {
     ...
     */
    @Autowired
    private MotherBoardFormFactorDao dao;
     ...
     */
    @GetMapping(value = "/motherboardformfactor/alldata", produces ="application/json" ) 
    public List<MotherBoardFormFactorEntity> allEmployeeData() {
