...
import lk.bytetechsolution.Dao.ModularityDao;
...
public class ModularityController {
     ...
     */
    @GetMapping(value = "/modularity/alldata", produces ="application/json" ) 
    public List<ModularityEntity> allEmployeeData() {
