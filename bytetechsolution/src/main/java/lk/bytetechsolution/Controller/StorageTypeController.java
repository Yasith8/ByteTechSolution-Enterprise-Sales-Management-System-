...
import lk.bytetechsolution.Dao.StorageTypeDao;
...
public class StorageTypeController {
     ...
     */
    @GetMapping(value = "/storagetype/alldata", produces ="application/json" ) 
    public List<StorageTypeEntity> allEmployeeData() {
