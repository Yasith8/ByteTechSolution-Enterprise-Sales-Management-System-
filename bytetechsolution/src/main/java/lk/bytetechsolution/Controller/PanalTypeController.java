...
import lk.bytetechsolution.Dao.PanalTypeDao;
...
*/
@RestController
public class PanalTypeController {
     /* 
     ...
     */
    @GetMapping(value = "/panaltype/alldata", produces ="application/json" ) 
    public List<PanalTypeEntity> allEmployeeData() {
