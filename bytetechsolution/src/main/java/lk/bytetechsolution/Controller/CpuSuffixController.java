...
import lk.bytetechsolution.Dao.CpuSuffixDao;
...
*/
@RestController
public class CpuSuffixController {
     /* 
     ...
     */
    @GetMapping(value = "/cpusuffix/alldata", produces ="application/json" ) 
    public List<CpuSuffixEntity> allEmployeeData() {
