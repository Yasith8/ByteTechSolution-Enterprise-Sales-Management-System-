...
import lk.bytetechsolution.Dao.StorageInterfaceDao;
...
public class StorageInterfaceController {
     ...
     */
    @Autowired
    private StorageInterfaceDao dao;
     /* 
     ...
     */
    @GetMapping(value = "/storageinterface/alldata", produces ="application/json" ) 
    public List<StorageInterfaceEntity> allEmployeeData() {
