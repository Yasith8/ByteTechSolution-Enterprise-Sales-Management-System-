...
import lk.bytetechsolution.Dao.MemoryFormFactorDao;
import lk.bytetechsolution.Entity.MemoryFormFactorEntity;
...
*/
@RestController
public class MemoryFormFactorController {
    /* 
     ...
     */
    @Autowired
    private MemoryFormFactorDao dao;
     /* 
     ...
     * 
     * also you can use
     * @requestMapping(value="/memoryformfactor/alldata",produces='application.json',method=RequestMethod.GET)
     */
    @GetMapping(value = "/memoryformfactor/alldata", produces ="application/json" ) 
    public List<MemoryFormFactorEntity> allEmployeeData() {
