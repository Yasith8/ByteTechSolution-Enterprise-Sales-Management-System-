...
import lk.bytetechsolution.Dao.EfficiencyDao;
...
public class EfficiencyController {
     ...
     */
    @GetMapping(value = "/efficiency/alldata", produces ="application/json" ) 
    public List<EfficiencyEntity> allEmployeeData() {
