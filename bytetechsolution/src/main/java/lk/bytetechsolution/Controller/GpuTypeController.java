...
import lk.bytetechsolution.Dao.GpuTypeDao;
...
public class GpuTypeController {
     ...
     */
    @GetMapping(value = "/gputype/alldata", produces ="application/json" ) 
    public List<GpuTypeEntity> allEmployeeData() {
