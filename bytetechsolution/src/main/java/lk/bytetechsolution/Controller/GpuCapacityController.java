...
import lk.bytetechsolution.Dao.GpuCapacityDao;
...
*/
@RestController
public class GpuCapacityController {
      /* 
     ...
     */
    @GetMapping(value = "/gpucapacity/alldata", produces ="application/json" ) 
    public List<GpuCapacityEntity> allEmployeeData() {
